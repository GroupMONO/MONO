...
<html>
<head>
  <title>Edit Course Coordinator Account</title>
...
<body>
  ...
  ?>
	...
	<?php
		...
		$row=mysqli_fetch_array($cc_query);
	?>

	<div>
		<h3>Edit Course Coordinator Account</h3>
      ...
      <div>
       ...
       <button><a id="back" href="cc.php">Back</a></button> 
      </div>
    </div>
		</form>
		 <?php 
    	if(isset($_POST['save']))
    	{
	      ...
	      mysqli_query($connect, "update cc set username ='$username',password='$password',fullname='$fullname',email='$email',programme='$programme' where ccid='$get_id'")or die(mysqli_error());
	      echo('<script>location.href="cc.php"</script>');
	    }
    ?>
	</div>
</body>
