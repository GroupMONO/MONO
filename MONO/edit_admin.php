  ...
  ?>
	...
	<div>
      ...
      <div>
       ...
       <button><a id ="back" href="admin.php">Back</a></button>
      </div>
    </div>
    	...
    	if(isset($_POST['save']))
    	{
	      ...
	      mysqli_query($connect, "update user set username ='$username',password='$password',fullname='$fullname',email='$email',programme='$programme' where userid='$get_id'")or die(mysqli_error());
