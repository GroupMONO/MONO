  ...
  <h3>Add Admin Account</h3>
    <form method="post" name="myform" onsubmit="return validate()">
      ...
      if(isset($_POST['save']))
      {
        ...
        mysqli_query($connect, "insert into user (username,password,fullname,email,programme) values ('$username','$password','$fullname','$email','$programme')")or die(mysqli_error());
