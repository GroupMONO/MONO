...
<html lang="en">
<head>
  <title>Add Course Coordinator Account</title>
...
<body>
  ...
  <h3>Add Course Coordinator Account</h3>
    <form method="post" name="myform" onsubmit="return validate()">
      ...
      if(isset($_POST['save']))
      {
        ...
        mysqli_query($connect, "insert into cc (username,password,fullname,email,programme) values ('$username','$password','$fullname','$email','$programme')")or die(mysqli_error());
