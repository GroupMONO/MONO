  ...
  ?>
	<nav class="nav-area">
      <ul>
          ...
          <li><a class="active" href="update_profile_admin.php">Profile</a></li>
	...
	<div>
      ...
      <div>
       ...
       <button><a id="back" href="update_profile_admin.php">Back</a></button> 
      </div>
    </div>
		</form>
		 <?php 
    	if(isset($_POST['save']))
    	{
	      ...
	      mysqli_query($connect, "update user set password='$password',email='$email' where userid='$session_id'")or die(mysqli_error());
	      echo('<script>location.href="update_profile_admin.php"</script>');
	    }
    ?>
	</div>
</body>
