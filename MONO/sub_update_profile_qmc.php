	...
	<div>
		...
		<form method="post" name="myform" onsubmit="return validate()">
	      	...
	      	<br>
	      	  <div>
	      	    <div>
	       		  ...
	       		  <button><a id="back" href="update_profile_qmc.php">Back</a></button> 
	            </div>
	          </div>
	    	...
	    	if(isset($_POST['save']))
	    	{
		      ...
		      mysqli_query($connect, "update qmc set qpassword='$password',qemail='$email' where qmcid='$session_id'")or die(mysqli_error());
		      echo('<script>location.href="update_profile_qmc.php"</script>');
		    }
	    ?>
		</div>
</body>
