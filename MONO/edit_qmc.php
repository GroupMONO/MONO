...
<html>
<head>
  <title>Edit Quality Management Committee Account</title>
...
<body>
  ...
  ?>
	...
	<?php
		...
		$row=mysqli_fetch_array($qmc_query);
	?>

	<div>
		<h3>Edit Quality Management Committee Account</h3>
      ...
      <div>
       ...
       <button><a id="back" href="qmc.php">Back</a></button>
    	...
    	if(isset($_POST['save']))
    	{
	      ...
	      mysqli_query($connect, "update qmc set qusername ='$username',qpassword='$password',qfullname='$fullname',qemail='$email',qprogramme='$programme' where qmcid='$get_id'")or die(mysqli_error());
