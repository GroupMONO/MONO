...
<html>
<head>
	<title>Quality Management Committee</title>
	<style>
		body{
...
<body>
	...
	<br>
	<button><a id="black" href="add_qmc.php">Add Quality Management Committee</a></button>
	<table class="table">
		<thead>
			<tr>
				<th>Username</th>
		...
		<tbody>
			<?php
				$query=mysqli_query($connect,"select * from qmc") or die(mysqli_error());
				while($row=mysqli_fetch_array($query)){
					...
					<td>
						<button><a id="black" href="edit_qmc.php<?php echo '?id=' . $qmc_id; ?>">Edit CC</a></button>
						<button><a id="black" href="delete_qmc.php<?php echo '?id=' . $qmc_id; ?>">Delete CC</a></button>
					</td>	
					</tr>
				<?php } ?>
		</tbody>
